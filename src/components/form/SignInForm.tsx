    ...
    <FormProvider {...form}>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-2/3 space-y-6">
          ...
          <p className='text-center text-sn text-gray-600 mt-2'>If you don't have an account you can <Link className='text-blue-500 hover:underline' href='/auth/sign-up'>Sign up</Link></p>
        </form>
