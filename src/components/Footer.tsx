    ...
    <footer className="bg-gray-800 text-gray-200">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">Satisfaction Guaranteed</h3>
            <p className="text-sm">Commerce Electronics is the best place to find deals on electronics!</p>
          </div>
